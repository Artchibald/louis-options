...
//close burger menu on click for anchor tags
$(function () {
...
var x = setInterval(function () {
    ...
    document.getElementById("countdownP").innerHTML = days + "\u00A0days - " + hours + "\u00A0hours - "
...
// edit css of homepage header on scroll
...
// //collapse replace text

// $('#speakerBtn').click(function () {
//     $(this).text(function (speakerBtnVar, old) {
//         return old == 'More Speakers +' ? 'Less Speakers -' : 'More Speakers +';
//     });
// });
// $('#aboutBtn').click(function () {
//     $(this).text(function (aboutBtnVar, old) {
//         return old == 'Read More +' ? 'Read Less -' : 'Read More +';
//     });
// });

// $('#imagesBtn').click(function () {
//     $(this).text(function (imagesBtnVar, old) {
//         return old == 'More Images +' ? 'Less Images -' : 'More Images +';
//     });
// });

// $('#moreSpeakers').on('show', function () {
//     $('#speakerBtn').html('Less Speakers -')
// });
// $('#moreSpeakers').on('hide', function () {
//     $('#speakerBtn').html('More Speakers +')
// });

$('#moreSpeakers').on('hidden.bs.collapse', function () {
    $('#speakerBtn').html('More Speakers <i class="fas fa-chevron-down"></i>');
});
$('#moreSpeakers').on('shown.bs.collapse', function () {
    $('#speakerBtn').html('Less Speakers <i class="fas fa-chevron-up"></i>');
});
$('#aboutReadMore').on('hidden.bs.collapse', function () {
    $('#aboutBtn').html('Read More <i class="fas fa-chevron-down"></i>');
});
$('#aboutReadMore').on('shown.bs.collapse', function () {
    $('#aboutBtn').html('Read Less <i class="fas fa-chevron-up"></i>');
});
$('#moreGallery').on('hidden.bs.collapse', function () {
    $('#imagesBtn').html('More Images <i class="fas fa-chevron-down"></i>');
});
$('#moreGallery').on('shown.bs.collapse', function () {
    $('#imagesBtn').html('Less Images <i class="fas fa-chevron-up"></i>');
});